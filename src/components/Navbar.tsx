...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 w-full z-50 bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl border-b border-gray-100 dark:border-cyan-500/20 transition-all duration-500 shadow-lg shadow-gray-200/50 dark:shadow-cyan-500/10">
