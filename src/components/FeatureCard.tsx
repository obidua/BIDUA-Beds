...
const FeatureCard: React.FC<FeatureCardProps> = ({ feature }) => {
  ...
  return (
    <motion.div 
      ...
      className="bg-white dark:bg-gray-900 rounded-2xl p-8 border border-gray-200 dark:border-gray-700 hover:border-gray-500 transition-all duration-500 hover:shadow-2xl hover:shadow-gray-500/20 group"
    >
      <div className="flex items-center space-x-4 mb-6">
        <motion.div 
          ...
          className="p-4 bg-gradient-to-br from-cyan-400 to-blue-500 rounded-2xl transition-all duration-500 shadow-lg"
        >
