  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-500">
      ...
      <motion.section 
        ...
        className="pt-12 pb-20 text-center max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 bg-white dark:bg-gray-950 relative overflow-hidden"
      >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 relative z-10">
            {[
              ...
              >
                ...
                >
                  <div className="p-4 bg-cyan-100 dark:bg-cyan-900 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700">
